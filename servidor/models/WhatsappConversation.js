...
const whatsappConversationSchema = new mongoose.Schema({
  ...
  automationOptIn: { type: Boolean, default: false, index: true },
  automationOptInAt: { type: Date, default: null },
  automationOptInBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null },
