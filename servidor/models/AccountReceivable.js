...
const installmentSchema = new Schema(
  {
    ...
    originalValue: { type: Number, min: 0, default: 0 },
    paidValue: { type: Number, min: 0, default: 0 },
    paidDate: { type: Date },
    ...
    paymentDocument: { type: String, trim: true, default: '' },
    paymentNotes: { type: String, trim: true, default: '' },
    residualValue: { type: Number, min: 0, default: 0 },
    residualDueDate: { type: Date },
    originInstallmentNumber: { type: Number, min: 1 },
