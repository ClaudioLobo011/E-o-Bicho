...
const whatsappAutomationConfigSchema = new mongoose.Schema({
  ...
  manualChatActivation: { type: Boolean, default: false },
  aiEnabled: { type: Boolean, default: false },
  aiEndpoint: { type: String, trim: true, default: 'http://127.0.0.1:18080' },
  aiModel: { type: String, trim: true, default: 'zoe-local' },
  aiSystemPrompt: { type: String, trim: true, default: '' },
  aiMaxTokens: { type: Number, min: 80, max: 500, default: 220 },
  aiTimeoutMs: { type: Number, min: 5000, max: 120000, default: 60000 },
