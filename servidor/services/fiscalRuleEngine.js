...
const normalizeCfop = (cfop = {}) => ({
  entrada: toStringSafe(cfop.entrada || cfop.entradaEstado || cfop.cfopEntrada),
  dentroEstado: toStringSafe(cfop.dentroEstado || cfop.dentro),
  foraEstado: toStringSafe(cfop.foraEstado || cfop.fora),
...
const FIELD_LABELS = {
  ...
  csosn: 'CSOSN',
  cst: 'CST',
  'cfop.nfe.entrada': 'CFOP NF-e entrada',
  ...
  'cfop.nfce.entrada': 'CFOP NFC-e entrada',
