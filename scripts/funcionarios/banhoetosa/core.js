...
export const els = {
  ...
  customerSearchModal: document.getElementById('agenda-customer-search-modal'),
  customerSearchModalBackdrop: document.querySelector('[data-agenda-customer-search-dismiss="backdrop"]'),
  customerSearchModalClose: document.getElementById('agenda-customer-search-modal-close'),
  customerSearchModalInput: document.getElementById('agenda-customer-search-modal-input'),
  customerSearchModalButton: document.getElementById('agenda-customer-search-modal-btn'),
  customerSearchModalLoading: document.getElementById('agenda-customer-search-modal-loading'),
  customerSearchModalTable: document.getElementById('agenda-customer-search-modal-table'),
  customerSearchModalResults: document.getElementById('agenda-customer-search-modal-results'),
  customerSearchModalEmpty: document.getElementById('agenda-customer-search-modal-empty'),
  customerSearchInput: document.getElementById('agenda-customer-search'),
  customerSearchButton: document.getElementById('agenda-customer-search-btn'),
  customerClearSelectionButton: document.getElementById('agenda-customer-clear-selection'),
  customerTabBtnCliente: document.getElementById('agenda-customer-tab-btn-cliente'),
  customerTabBtnPet: document.getElementById('agenda-customer-tab-btn-pet'),
  customerTabCliente: document.getElementById('agenda-customer-tab-cliente'),
  customerTabPet: document.getElementById('agenda-customer-tab-pet'),
  customerSaveToggle: document.getElementById('agenda-customer-save-toggle'),
  customerRequiredName: document.getElementById('agenda-customer-required-name'),
  customerRequiredDoc: document.getElementById('agenda-customer-required-doc'),
  customerRequiredSexo: document.getElementById('agenda-customer-required-sexo'),
  customerRequiredCep: document.getElementById('agenda-customer-required-cep'),
  customerRequiredPhone1: document.getElementById('agenda-customer-required-phone1'),
  customerConfirmButton: document.getElementById('agenda-customer-confirm'),
  customerClearButton: document.getElementById('agenda-customer-clear'),
  customerCancelButton: document.getElementById('agenda-customer-cancel'),
  customerResultsLoading: document.getElementById('agenda-customer-results-loading'),
  customerResultsEmpty: document.getElementById('agenda-customer-results-empty'),
  customerResultsTable: document.getElementById('agenda-customer-results-table'),
  customerResults: document.getElementById('agenda-customer-results'),
  customerAddressCards: document.getElementById('agenda-customer-address-cards'),
  customerAddressCardsStatus: document.getElementById('agenda-customer-address-cards-status'),
  customerPetsLoading: document.getElementById('agenda-customer-pets-loading'),
  customerPetsEmpty: document.getElementById('agenda-customer-pets-empty'),
  customerPets: document.getElementById('agenda-customer-pets'),
  customerCode: document.getElementById('agenda-customer-code'),
  customerName: document.getElementById('agenda-customer-name') || document.getElementById('agenda-customer-search'),
  customerDoc: document.getElementById('agenda-customer-doc'),
  customerSexo: document.getElementById('agenda-customer-sexo'),
  customerBirth: document.getElementById('agenda-customer-birth'),
  customerEmail: document.getElementById('agenda-customer-email'),
  customerAddress: document.getElementById('agenda-customer-address'),
  customerNumber: document.getElementById('agenda-customer-number'),
  customerCep: document.getElementById('agenda-customer-cep'),
  customerBairro: document.getElementById('agenda-customer-bairro'),
  customerCidade: document.getElementById('agenda-customer-cidade'),
  customerUf: document.getElementById('agenda-customer-uf'),
  customerObservacao: document.getElementById('agenda-customer-observacao'),
  customerComplemento: document.getElementById('agenda-customer-complemento'),
  customerPhone1Ddd: document.getElementById('agenda-customer-phone1-ddd'),
  customerPhone1: document.getElementById('agenda-customer-phone1'),
  customerPhone2Ddd: document.getElementById('agenda-customer-phone2-ddd'),
  customerPhone2: document.getElementById('agenda-customer-phone2'),
  customerPetCode: document.getElementById('agenda-customer-pet-code'),
  customerPetName: document.getElementById('agenda-customer-pet-name'),
  customerPetTipo: document.getElementById('agenda-customer-pet-tipo'),
  customerPetSexo: document.getElementById('agenda-customer-pet-sexo'),
  customerPetPorte: document.getElementById('agenda-customer-pet-porte'),
  customerPetRaca: document.getElementById('agenda-customer-pet-raca'),
  customerPetRacaSuggest: document.getElementById('agenda-customer-pet-raca-suggest'),
  customerPetBirth: document.getElementById('agenda-customer-pet-birth'),
  customerPetCor: document.getElementById('agenda-customer-pet-cor'),
  customerPetCodAnt: document.getElementById('agenda-customer-pet-cod-ant'),
  customerPetMicrochip: document.getElementById('agenda-customer-pet-microchip'),
  customerPetRga: document.getElementById('agenda-customer-pet-rga'),
  customerPetPeso: document.getElementById('agenda-customer-pet-peso'),
  customerPetCastrado: document.getElementById('agenda-customer-pet-castrado'),
  customerPetObito: document.getElementById('agenda-customer-pet-obito'),
};
